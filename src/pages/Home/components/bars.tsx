const Bars = () => {
  return (
    <div className="relative inline-flex group w-full my-5">
      <div className="absolute transitiona-all duration-1000 opacity-30 -inset-px bg-gradient-to-r from-[#44BCFF] via-lime-300 to-purple-300 rounded-xl blur-3xl group-hover:opacity-40 group-hover:inset-0 group-hover:duration-200 animate-tilt"></div>
